...
class LoginFragment : Fragment(R.layout.fragment_login) {
    ...
    private lateinit var gift : ImageView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gift=view.findViewById(R.id.imageView3)
        ...
        gift.setOnClickListener{
            val url = "https://www.tripadvisor.com/"
            ...
            FirebaseAuth.getInstance()
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful){
                        ...
                        val goToProfile = LoginFragmentDirections.actionLoginFragmentToProfileFragment()
